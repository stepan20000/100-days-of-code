...
**Today's Progress**: Technically I have finished portfolio. All is working nice, only fonts colors and maybe some styling remains to be done.    
...
**Today's Progress**: Started to build the calculator. 
...
**Link(s) to work**: 
1. [Tic Tac Toe Game](https://github.com/stepan20000/stepan20000.github.io/blob/master/pomodoro.html)
...
## Day 87 April 5, 2017, Wednesday
#####

**Today's Progress**: Almost completed styling. Added logic to the user's choice of game parameters. 

**Thoughts**: Have to start making logic for the game-flow.  

**Link(s) to work**: 
1. [Tic Tac Toe Game](https://github.com/stepan20000/stepan20000.github.io/blob/master/tic-tac-toe.html)

## Day 88 April 6, 2017, Thursday
#####

**Today's Progress**:Really big progress in tictac. Started to make the computerRun logic. Almost finished workflow.   
...
## Days 90 - 91 April 8 & April 10, 2017, Saturday & Monday
#####

**Today's Progress**: Almost made game workflow. Working with algorithm for computer playing.    
...
## Day 92 April 11, 2017, Tuesday
#####

**Today's Progress**: All day working with algorithm for computer steps. Just got confused already in everything  
...
## Day 93 April 12, 2017, Wednesday
#####

**Today's Progress**: Completed algorithm fo computer. Have to test it very thoroughly. 

**Thoughts**:  Think I have to well comment this project. 

**Link(s) to work**: 
1. [Tic Tac Toe Game](https://github.com/stepan20000/stepan20000.github.io/blob/master/tic-tac-toe.html)

## Day 95 April 13, 2017, Thursday
#####

**Today's Progress**: Tic Tac Toe Game. Searched for bugs, fixed them and corrected the algorithm (in fact, wrote a lots of new code) 

**Thoughts**:  Still have to well comment this project. 

**Link(s) to work**: 
1. [Tic Tac Toe Game](https://github.com/stepan20000/stepan20000.github.io/blob/master/tic-tac-toe.html)

## Day 96 April 14, 2017, Friday
#####

**Today's Progress**: Tic Tac Toe Game.  Make work the two players game. Fixed a lot of bugs. 

**Thoughts**:  And still have to well comment this project. 

**Link(s) to work**: 
1. [Tic Tac Toe Game](https://github.com/stepan20000/stepan20000.github.io/blob/master/tic-tac-toe.html)

## Day 97 April 15, 2017, Saturday
#####

**Today's Progress**: Finished Tic Tac Toe Game!!!!! And also commented the code.  

**Thoughts**:  Nice project. And seems I made it fine. 
...
## Day 100 April 18, 2017, Tuesday
#####

**Today's Progress**: Added some code to the Simon. Partially made the controls panel.  
